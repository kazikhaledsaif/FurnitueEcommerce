...
<head>
    ...
    <title>Shop == FurnitureVilla-Texas || Luxury starts here</title>
                                ...
                                <ul>
                                    <li>
                                        <label class="radio-container">
                                            ...
                                            <a href="{{route('shop.index', ['price_min' => 400,'price_max' => 999 ])}}"> $400.00 - $999.00
                                    ...
                                    <li>
                                        <label class="radio-container">
                                            <a href="{{route('shop.index', ['price_min' => 1000,'price_max' => 1499 ])}}"> $1000.00 - $1499.00
                                    ...
                                    <li>
                                        <label class="radio-container">
                                            <a href="{{route('shop.index', ['price_min' => 1500,'price_max' => 1999 ])}}"> $1500.00 - $1999.00
                                    ...
                                    <li>
                                        <label class="radio-container">
                                            <a href="{{route('shop.index', ['price_min' => 2000,'price_max' => 4000 ])}}"> $2000.00 - $4000.00
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 d-flex flex-column flex-sm-row justify-content-start justify-content-md-end align-items-sm-center">
                            ...
                            <div class="sort-by-dropdown d-flex align-items-center mb-xs-10">
                                ...
                                <select name="sort-by" id="sort-by" class="nice-select"  onchange="location = this.value;">
                                    ...
                                    <option  value="{{route('shop.index', ['category' => request()->category,'sort'=>'low_high' ])}}">
                                        <a href=""> Price: Low to High</a></option>

                                    <option value="{{route('shop.index', ['category' => request()->category,'sort'=>'high_low' ])}}">
                                        <a href="{{route('shop.index', ['category' => request()->category,'sort'=>'high_low' ])}}"> Price: High to Low</a></option>
                ...
                <div class="shop-product-wrap grid row">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                        ...
                        <div class="ptk-product shop-grid-view-product">
                            <div class="image">
                                <form action="{{route('cart.store')}}" id="link-cart{{ $product->id }}" method="POST">
                                <a href="{{route('shop.show',$product->slug)}}">
                                    <img src="{{ asset('storage/'.$product->product_image)  }}" class="img-fluid shop-thumb" alt="{{ $product->name }}">
                                </a>
                                <!--=======  hover icons  =======-->
                                ...
                                <form  id="link-wish{{ $product->id }}" action="{{route('wishlist.store')}}" method="POST">
                                    {{csrf_field()}}
                        ...
                        <div class="ptk-product shop-list-view-product">
                            <div class="image">
                                <a href="{{route('shop.show',$product->slug)}}">
                                    <img src="{{ asset('storage/'.$product->product_image)  }}" class="img-fluid shop-thumb" alt="">
                                </a>
                            ...
                            <div class="content">
                                ...
                                <div class="hover-icons">
                                    {{--<a class="hover-icon quickview" id="quickmodal" href="#"--}}
                                       {{--data-pid="{{ $product->id }}" data-pname="{{ $product->name }}" data-price="{{ $product->present_price }}"--}}

...
<head>
    ...
    <title>FurnitureVille-Texas || Luxury starts here</title>
    ...
    <link rel="stylesheet" type="text/css" href="{{ URL::to('frontend/css/linear-icon.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ URL::to('frontend/css/plugins.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ URL::to('frontend/css/helper.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ URL::to('frontend/css/main.css') }}">

    <script type="text/javascript" src="{{ URL::to('frontend/js/bootstrap.min.js') }}"></script>
    <script type="text/javascript" src="{{ URL::to('frontend/js/vendor/modernizr-2.8.3.min.js') }}"></script>
...
{{--    <script>
            ...
            switch(type){
                        case 'info':
                            toastr.info("{{ Session::get('success_message') }}");
                            break;

                        case 'warning':
                            toastr.warning("{{ Session::get('success_message') }}");
                            break;
                        ...
                        case 'error':
                            toastr.error("{{ Session::get('success_message') }}");
                            break;}
            ...
            <div class="col-lg-12 pl-0 pr-0">
                ...
                <div class="slider-container">
                    ...
                    <div class="hero-slider-one">
                        ...
                        <?php
                            $attr =  asset('storage/'.$slider->img);
                            $at=   str_replace('\\', '/',$attr);
                            ?>
                        
                        {{-- <div class="hero-slider-item" style="background-image: url({{ asset('storage/'.$slider->img)  }})"> --}}
            ...
            <div class="col-lg-6 col-md-6 mb-sm-30">
                ...
                <div class="banner">
                    <a href="/shop?category={{$featuredCategory[0]->slug}}">
                        <img src="{{ asset('storage/'.$featuredCategory[0]->image) }}" class="img-fluid" alt="">
                    </a>
                    ...
                    <div class="col-lg-12 col-md-12 mb-30">
                        ...
                        <div class="banner">
                            <a href="/shop?category={{$featuredCategory[1]->slug}}">
                                <img src="{{ asset('storage/'.$featuredCategory[1]->image) }}" class="img-fluid extra_image" alt="">
                            </a>
                            <span class="banner-category-title">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                        ...
                        <div class="banner">
                            <a href="/shop?category={{$featuredCategory[2]->slug}}">
                                <img  src="{{ asset('storage/'.$featuredCategory[2]->image) }}" class="img-fluid " alt="">
                            </a>
                            <span class="banner-category-title">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                        ...
                        <div class="banner">
                            <a href="/shop?category={{$featuredCategory[3]->slug}}">
                                <img src="{{ asset('storage/'.$featuredCategory[3]->image) }}" class="img-fluid" alt="">
                            </a>
                            <span class="banner-category-title">
                    ...
                    @foreach($new_products as $new)
                        ...
                        <div class="col">
                            ...
                            <div class="ptk-product">
                                <div class="image">
                                    <form action="{{route('cart.store')}}" id="link-cart{{ $new->id }}" method="POST">
                                        <a  href="{{route('shop.show',$new->slug)}}" >
                                            <img src="{{ asset('storage/'.$new->product_image)  }}" class="img-fluid home-thumb" alt="">
                                        </a>
                                        <!--=======  hover icons  =======-->
                                    ...
                                    <form  id="link-wish{{ $new->id }}" action="{{route('wishlist.store')}}" method="POST">
                                        {{csrf_field()}}
                                ...
                                <div class="content">
                                    <p class="product-title"><a href="{{route('shop.show',$new->slug)}}" target="_blank">{{$new->name}}</a></p>
                            ...
                            @endphp
                                <div class="col">
                                    ...
                                    <span class="discount-badge">
                                        ...
                                        <div class="content">
                                            <p class="product-title"><a href="{{route('shop.show',$new->slug)}}">{{$new->name}}</a></p>
                                            <p class="product-price">
                                                @if( $new->discount_price == 0 )
                                                    <span class="main-price"> ${{ $new->present_price }}</span>
                                                @else
                        ...
                        <div class="ptk-slider popular-product-slider" data-row="3">
                            ...
                            <div class="col">
                                ...
                                <div class="ptk-product d-flex">
                                    <div class="image">
                                        <a href="{{route('shop.show',$new->slug)}}">
                                            <img src="{{ asset('storage/'.$new->product_image)  }}" class="img-fluid " alt="">
                                        </a>
                                    </div>
                                    <div class="content">
                                        <p class="product-title"><a href="{{route('shop.show',$new->slug)}}">{{$new->name}}</a></p>
            ...
            <div class="col-lg-12">
                ...
                <div class="ptk-slider top-selling-product-slider-container">
                    ...
                    <div class="col">
                        ...
                        <div class="ptk-product">
                            <div class="image">
                                <form action="{{route('cart.store')}}" id="link-cart{{ $top->product_id }}" method="POST">
                                        <a href="{{route('shop.show',$top->slug)}}">
                                            <img src="{{ asset('storage/'.$top->product_image)  }}" class="img-fluid " alt="">
                                        </a>
                                ...
                                <form  id="link-wish{{ $top->product_id }}" action="{{route('wishlist.store')}}" method="POST">
                                    {{csrf_field()}}
                            ...
                            <div class="content">
                                            <p class="product-title"><a href="{{route('shop.show',$new->slug)}}">{{$top->name}}</a></p>
                                            <p class="product-price">
                                                @if( $top->discount_price == 0 )
                                ...
                                <div class="tab-content product-large-image-list quickview-product-large-image-list">
                                    <div class="tab-pane fade show active"
                                        ...
                                        <div class="single-product-img img-full">
                                            <img src="{{ asset('storage/'.$top->product_image)  }}"
